...
function Header() {
  const [responseJsonData, setResponseJsonData] = useState(null);
        ...
        <div className="sequio__dashboard-content">
          <div className="sequio__dashboard-content-container">
            <div class="sequio__dashboard-content-container-grid-item">
              ...
              <p>{responseJsonData.responses[0].response_data.question_responses[0].total_score}%</p>
